...
function HeaderMenu(props) {
  ...
  return (
    <header className="flex justify-around items-center h-[80px] text-[#192a56]">
      <div className=" w-1/4 text-[2rem] font-bold">
        <NavLink
          to="/"
      ...
      {admin ? (
        ...
        <ul className="w-1/4 flex justify-center items-center">
          <li className="mr-4 bg-[#27ae60] text-white py-1 px-5 rounded-lg cursor-pointer duration-75 hover:bg-[#192a56]">
            <NavLink to="/login">Login</NavLink>
          </li>
          <li className=" bg-[#192a56] text-white py-1 px-5 rounded-lg cursor-pointer duration-75 hover:bg-[#27ae60]">
